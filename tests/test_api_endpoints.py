...
@pytest.fixture
def api_client():
    """Create a TestClient with mocked startup/shutdown lifecycle."""
...
@pytest.fixture
def api_client_with_resource_manager():
    """Create a TestClient with mocked resource manager."""
    from fastapi.testclient import TestClient
    from src.api.main import app
...
class TestResourceStatusEndpoint:
    ...
    def test_resource_status(self, api_client_with_resource_manager):
        """Should return resource manager status."""
        response = api_client_with_resource_manager.get("/resource/status")
...
class TestResearchRunEndpoint:
    ...
    def test_run_research_success(self, api_client):
    ...
    def test_run_research_error(self, api_client):
    ...
    def test_run_research_with_model_override(self, api_client):
...
class TestResearchValidateEndpoint:
    ...
    def test_validate_success(self, api_client):
    ...
    def test_validate_not_found(self, api_client):
...
class TestResearchListEndpoint:
    ...
    def test_list_cards(self, api_client):
        ...
        with patch("src.api.services.research_service.list_cards", new_callable=AsyncMock) as mock_list:
            ...
            response = api_client.get("/research/list")
    ...
    def test_list_cards_with_pagination(self, api_client):
        """Should respect pagination parameters."""
        with patch("src.api.services.research_service.list_cards", new_callable=AsyncMock) as mock_list:
            mock_list.return_value = {"cards": [], "total": 0, "limit": 5, "offset": 10}

            response = api_client.get("/research/list?limit=5&offset=10")
    ...
    def test_list_cards_with_quality_filter(self, api_client):
        """Should filter by quality."""
        with patch("src.api.services.research_service.list_cards", new_callable=AsyncMock) as mock_list:
            mock_list.return_value = {"cards": [], "total": 0, "limit": 10, "offset": 0}

            response = api_client.get("/research/list?quality=good")
...
class TestDedupEvaluateEndpoint:
    ...
    def test_evaluate_dedup_low_signal(self, api_client):
    ...
    def test_evaluate_dedup_high_signal(self, api_client):
    ...
    def test_evaluate_dedup_minimal_request(self, api_client):
