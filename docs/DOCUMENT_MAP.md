...
├── core/                    # 핵심 문서 (필독)
├── technical/               # 기술 참조 문서
├── task-scheduler/           # Task Scheduler 설계 문서 (NEW)
...
| [task-scheduler-AS_IS_TO_BE_API_DESIGN-v1.md](technical/task-scheduler-AS_IS_TO_BE_API_DESIGN-v1.md) | As-Is/To-Be API 설계 |
...
3. [task-scheduler-AS_IS_TO_BE_API_DESIGN-v1.md](technical/task-scheduler-AS_IS_TO_BE_API_DESIGN-v1.md) - As-Is/To-Be API 설계
